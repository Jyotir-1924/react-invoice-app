      ...
      >
        <Stack spacing={10} mt={10} sx={{ width: "50%" }}>
          <Stack spacing={2}>
            <Typography
              ...
              sx={{
                ...
                background:
                  "linear-gradient(270deg,rgb(42, 182, 0),rgb(0, 139, 171),rgb(193, 0, 64))",
            ...
            >
              Fill out a form to create a clean, professional invoice in
              seconds.
            </Typography>
          </Stack>
          ...
          <Stack>
            <Button
              variant="contained"
              onClick={() => handleClick({ path: "/invoice-form" })}
              sx={{
                px: 5,
                py: 1.8,
                alignSelf: "center",
